...
* Gathering data from most static websites is a relatively straightforward process. JavaScript is used to load their content. These web pages require a different approach to collecting the desired public data.
